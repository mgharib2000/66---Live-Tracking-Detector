...
while videoCapture.isOpened():
    ...
    cv2.putText(image, "Framerate: " + str(int(fps)) + " FPS", (590, 70), cv2.FONT_HERSHEY_DUPLEX, 0.5, (0, 255, 255), 1)
    cv2.putText(image, "Current Time: " + strftime("%H: %M: %S"), (590, 90), cv2.FONT_HERSHEY_DUPLEX, 0.5, (0, 255, 255), 1)
